...
В  проекте используется комплексный подход к автоматизации тестирования веб-приложений. UI автотесты реализованы на ***Java*** с использованием фреймворка ***Selenide***. Применяются паттерны ***PageObject***.
...
## Разработаны автотесты на UI и API позитивные и негативные тесты на регистрацию и логин, на данный момент  сайт в разработке и это база проекта .
...
<img width="1427" alt="image" src="https://github.com/frion13/barfin-project/assets/112623336/94250ccf-f229-45cc-9326-fb9178355075">
...
## <a id="видео-примеры-прохождения-тестов">Видео пример прохождения тестов в Selenoid</a>
